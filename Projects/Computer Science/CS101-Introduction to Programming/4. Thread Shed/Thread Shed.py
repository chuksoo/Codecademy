# -*- coding: utf-8 -*-
"""
Created on Thu Jun 30 22:15:17 2022

@author: hotty
"""

# You’ve recently been hired as a cashier at the local sewing hobby shop, Thread Shed. 
# Some of your daily responsibilities involve tallying the number of sales during the 
# day, calculating the total amount of money made, and keeping track of the names of 
# the customers.

# Unfortunately, the Thread Shed has an extremely outdated register system and stores 
# all of the transaction information in one huge unwieldy string called daily_sales.

# All day, for each transaction, the name of the customer, amount spent, types of 
# thread purchased, and the date of sale is all recorded in this same string. Your 
# task is to use your Python skills to iterate through this string and clean up 
...
# strip whitespaces and add each of cleaned up transactions to the new list `transactions_clean`
transactions_clean = []
...
threads_sold = []
transaction_date = []
for daily_sales in transactions_clean:
  customers.append(daily_sales[0])
...
# test function
#print(color_count('white')) # Ans: 28
